...
(
	...
	CONSTRAINT FK_Emprunteur FOREIGN KEY ([Emprunteur_Id]) REFERENCES [Utilisateur] ([Utilisateur_Id]),
	CONSTRAINT FK_Preteur FOREIGN KEY ([Preteur_Id]) REFERENCES [Utilisateur] ([Utilisateur_Id]),
